export const SKILLS_LIST = [
  'Writing','Research','Data analysis','Project management','Communications',
  'Teaching/training','Design','Finance','Policy','Engineering',
  'Community building','Social media','Operations','Sales',
  'Product management','Software/tech','Monitoring and evaluation',
]
...
export const STEPS = [
  {
    key: 'role', type: 'single', label: 'Your Profile',
  ...
  {
    key: 'skills', type: 'multi', label: 'Skills',
    question: 'What skills do you currently have?',
    hint: 'Select all that apply',
    options: SKILLS_LIST,
  },
  {
    key: 'interests', type: 'multi', label: 'Interests',
    question: 'What topics interest you most?',
    hint: 'Select all that apply',
    options: INTERESTS_LIST,
  },
  {
    key: 'workStyle', type: 'multi', label: 'Work Style',
    question: 'What kind of work do you enjoy?',
    hint: 'Select all that apply',
    options: WORKSTYLE_LIST,
  },
  {
    key: 'experience', type: 'single', label: 'Experience',
    question: 'How much climate experience do you currently have?',
    options: ['None yet','Beginner','Intermediate','Advanced'],
  },
  {
    key: 'goal', type: 'single', label: 'Goals',
    question: 'What is your biggest goal right now?',
    options: [
      'Find a climate job','Transition into climate work','Understand where I fit',
      'Build climate skills','Start a climate business','Improve my CV/profile',
    ],
  },
]
