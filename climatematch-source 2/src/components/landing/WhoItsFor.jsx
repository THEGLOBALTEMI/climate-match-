const AUDIENCES = [
  ...
  { icon: '🚀',                   title: 'Entrepreneurs',        body: 'You want to build a climate venture and need to understand where your skills fit.' },
]
    ...
    <section className="py-24 bg-white px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-forest mt-3 mb-4">ClimateMatch is for anyone<br />ready to make the move</h2>
        </div>
        ...
        <div className="text-center mt-12">
          <button onClick={onStart} className="bg-forest text-white font-bold px-8 py-4 rounded-full hover:bg-pine transition-all shadow-lg hover:-translate-y-0.5">
