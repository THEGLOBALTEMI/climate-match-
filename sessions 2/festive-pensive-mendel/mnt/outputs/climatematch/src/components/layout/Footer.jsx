    ...
    <footer className="bg-forest text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-black text-xl">
                Climate<span className="text-mint">Match</span>
              </span>
            </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-white/40">
          <span>© {new Date().getFullYear()} ClimateMatch. All rights reserved.</span>
          <span className="font-medium">climatematch.tech</span>
          <span className="bg-amber-500/20 text-amber-300 px-3 py-1 rounded-full font-semibold">
            Currently in beta
          </span>
        </div>
      </div>
